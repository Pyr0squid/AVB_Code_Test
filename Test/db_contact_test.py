...
def test_db_initialization():
    ...
    create_db_instance(
        "../Backend/Database/schema.sql", "../Backend/Database/database.db"
    )
...
def test_get_all_names_basic():
    ...
    repo = Repository("../Backend/Database/database.db")
    contact = Contact(
        first_name=first_name, middle_name_init=middle_init, last_name=last_name
    )
...
def test_delete_address_basic():
    ...
    repo = Repository("../Backend/Database/database.db")
    contact = Contact(
        first_name=first_name, last_name=last_name, e_addresses=e_addresses
    )
