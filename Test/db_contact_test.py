...
def test_contact_equality():
    ...
    # test with same ids
    contact1 = Contact(id=1, first_name=first_name, middle_name_init=middle_init, last_name=last_name, birthday=birthday, e_addresses=e_addresses)
    assert contact1 == contact1

    # test with None ids
    contact2 = Contact(first_name=first_name, middle_name_init=middle_init, last_name=last_name, birthday=birthday, e_addresses=e_addresses)
    assert contact1 == contact2
    assert contact2 == contact2

    # test with wrong fields
    contact3 = Contact(id=1, first_name=first_name, last_name=last_name, birthday=birthday, e_addresses=e_addresses)
...
def test_insert_basic():
    ...
    contact = Contact(first_name=first_name, middle_name_init=middle_init, last_name=last_name, birthday=birthday, e_addresses=e_addresses)
